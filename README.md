# US_gasoline_demand_function
This work aims to create an econometric model in order to estimate the gasoline demand function in US and its elasticity, given a set of data. It contains:
